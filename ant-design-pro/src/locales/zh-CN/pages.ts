export default {
  ...
  'pages.login.password.placeholder': '请输入登录密码',
  ...
  'outlook.accounts.subtitle': '管理已接入的邮箱账号',
  'outlook.mailbox.title': '邮箱',
  'outlook.mailbox.subtitle': '阅读与管理选中账号的邮件',
  'outlook.pool.title': '邮箱池管理',
  'outlook.pool.subtitle': '管理邮箱池状态与申领',
  'outlook.settings.title': '系统设置',
  'outlook.settings.subtitle': '配置访问密钥、白名单与部署选项',
  'outlook.audit.title': '审计日志',
  'outlook.audit.subtitle': '查看系统操作记录与追踪信息',
  'outlook.groups.title': '分组管理',
  'outlook.groups.subtitle': '管理账号分组与颜色标识',
  'outlook.overview.title': '概览',
  'outlook.overview.subtitle': '查看账号、验证码与邮箱池运行情况',
  'outlook.plugins.title': '插件管理',
  'outlook.plugins.subtitle': '安装与管理扩展插件',
  'outlook.tempEmails.title': '临时邮箱',
  'outlook.tempEmails.subtitle': '管理临时邮箱地址',
  'outlook.refreshLog.title': '刷新日志',
  'outlook.refreshLog.subtitle': '查看账号令牌刷新记录',
  'outlook.tokenTool.title': 'Token 工具',
  'outlook.tokenTool.subtitle': '获取与刷新邮箱授权令牌',
};
